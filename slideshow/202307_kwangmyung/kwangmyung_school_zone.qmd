...
cctv_tbl <- read_rds("data/km_cctv_tbl.rds")
km_sf <- read_rds("data/km_km_sf.rds")
km_school <- read_rds("data/km_km_school.rds")
...
accident_2016 <- read_excel("../map_challenge/data/km_accident_2014_2016.xlsx")
accident_2019 <- read_excel("../map_challenge/data/km_accident_2017_2019.xlsx")
accident_2022 <- read_excel("../map_challenge/data/km_accident_2020_2022.xlsx")
...
accident_raw <- read_excel("../map_challenge/data/어린이_교통사고건수_시도_시_군_구__20230624195028.xlsx", sheet = "데이터",
           skip = 2)
...
## 광명시 카드사용금액(BC) &rarr; 작업중 {.smaller}
