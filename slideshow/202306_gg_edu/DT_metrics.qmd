...
![](img/public/esg-country-classic.png)
...
## 전통 지표 기준 강대국 {.smaller}

```{r}
#| label:  oecd-stats-traditional
library(tidyverse)
library(countrycode)
library(reactable)
library(htmltools)
...
![](img/public/esg-country-extension.png)

::: aside
- [위키백과 OECD](https://en.wikipedia.org/wiki/OECD)
:::

## 확장 지표 기준 선진국 {.smaller}

```{r}
#| label: oecd-esg-extended-quarto
...
# 디지털 전환 지표 <br> ㄴ 디지털 지표

## 디지털 강대국 지표 {.smaller}


![](img/public/oecd-dataset.png)
...
## 디지털 강대국 지표 - 디지털 정부 순위 {.smaller}

```{r}
#| label: digital-index-government-quarto
library(tidyverse)
library(reactable)
library(htmltools)
library(countrycode)
...
## 디지털 강대국 지표 - 인공지능 준비지수 {.smaller}

```{r}
#| label:  digital-index-ai-gov
...
## 디지털 강대국 지표 - 데이터 경제 {.smaller}

```{r}
#| label: digital-index-data-eco
...
## 디지털 강대국 지표 - 산업용 로봇 {.smaller}

```{r}
#| label: digital-index-robot-quarto
...
## 디지털 강대국 지표 - WEF 세계 경쟁력 {.smaller}

```{r}
#| label: digital-index-comp
...
## 디지털 강대국 지표 - IMD 디지털 경쟁력 {.smaller}

```{r}
#| label: digital-index-imd-quarto
...
## 디지털 강대국 지표 - 종합 {.smaller}

```{r}
#| label: digital-index-summary-quarto
